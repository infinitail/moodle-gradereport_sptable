...
// https://github.com/moodle/moodle/blob/MOODLE_38_STABLE/lib/excellib.class.php
class MoodleExcelWorkbookSP extends MoodleExcelWorkbook {
    public function add_worksheet($name = '') {
        return new MoodleExcelWorksheetSP($name, $this->objspreadsheet);
    }
}
...
class MoodleExcelWorksheetSP extends MoodleExcelWorksheet {
     ...
     * @param string $pos   - border postion
     *      [top, bottom, left, right, diagonal, allborders, outline, inside, vertical, horizontal]
